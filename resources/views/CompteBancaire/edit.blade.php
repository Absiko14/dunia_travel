                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <div class="card-block">
                                                    <h4 class="sub-title">Editer un Numéro Bancaire</h4>

                                                <form action="{{route('editagenceauth', ['agence'=>$agence->id])}}" method="POST">
                                                @csrf
                                                @method ('put')
                                                    <div class="mb-3">
                                                        <label for="setting-input-2" class="form-label">Numéro Bancaire</label>
                                                        <input type="text" class="form-control" name="num_banque" value="{{$agence->num_banque}}">
                                                    </div>
