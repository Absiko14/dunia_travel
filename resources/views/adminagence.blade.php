                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card table-card">
                                                    <div class="card-header">
                                                        <h5>Agence Sociaux</h5>
                                                        <a class="btn btn-primary f-right" href="{{ route('addagence') }}"> + Ajouter </a>
                                                            ...
                                                            <table class="table table-hover table-borderless">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $agence->sigle }}</td>
												                        <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('editagence', $agence->id) }}">Modifier</a></td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
                                                            </table>
