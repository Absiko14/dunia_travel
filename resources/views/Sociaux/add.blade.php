                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <div class="card-block">
                                                    <h4 class="sub-title">Ajouter un resaux sociau</h4>
                                                    <form class="settings-form" method="post" action="/addagence">
                                                    @csrf
                                                    @method('post') 
                                                    <div class="mb-3">
                                                        <label for="setting-input-2" class="form-label">Nom</label>
                                                        <input type="text" class="form-control col-sm-10" id="setting-input-2" name="nom">
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="setting-input-2" class="form-label">Lien du resaux</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="lienprofil">
                                                        </div>
                                                    </div>
