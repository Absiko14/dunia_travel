    ...
    <article>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <h2 class="h1 hero-title">{{ $agence->description }}</h2>

          <p class="hero-text">
            Voyagez au cœur de la nature pour vous déconnecter totalement du quotidien et
             vous émerveiller devant les multiples trésors de notre planète.
             Chaque destination dévoile ses propres merveilles !
          </p>
      ...
      <section class="popular" id="destination">
        <div class="container">
          ...
          <p class="section-subtitle"> A la decouverte des villes</p>

          <h2 class="h2 section-title">Nos destinations populaires</h2>

          <p class="section-text">
             Agences de voyages indépendantes au Mali, DUNIA TRAVEL vous
             permet de bénéficier de l'expertise qui vous accompagnent
              pour créer le voyage de vos rêves. 
               Séjours, circuits, croisières, vols, hôtels, expériences inoubliables, voyages sur mesure
             vous seront proposés en ligne ou dans nos agences de voyages.
          </p>
