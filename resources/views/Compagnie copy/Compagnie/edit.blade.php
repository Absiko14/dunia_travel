                                            ...
                                            <div class="card-block">
                                                ...
                                                @method ('put')
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Charger un Logo</label>
                                                        <div class="col-sm-10">
                                                            <input type="file" class="form-control" name="logo" value="{{$agence->logo}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="setting-input-2" class="form-label">Pays</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="pays" value="{{$agence->pays}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="setting-input-2" class="col-sm-3 col-form-label">Description</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="description" value="{{$agence->description}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="setting-input-2" class="col-sm-3 col-form-label">Sigle</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="sigle" value="{{$agence->sigle}}">
                                                        </div>
                                                    </div>
